...
public class Main extends Application {
    ...
    private List<Integer> getLevelNumbers() {
        ...
        for (int i = 1; i <= 99; i++) {
            ...
            String mapFilePath = MAPS_FILE_PREFIX + baseFilename + ".txt";        // e.g., "/maps/lvl_01.txt"
            String colorFilePath = COLORS_FILE_PREFIX + baseFilename + "_color.txt"; // e.g., "/colors/lvl_01_color.txt"
