...
public class GameManager {
   ...
   */
  public Group createSceneRoot(String levelName) {
  ...
  private void step (double elapsedTime) {
    for (Ball ball : myBalls) {
      // Check and bounce off wall and paddle if necessary
      ball.bounceOffEdge(mySceneWidth);
      ball.bounceOffPaddle(myPaddle);
  ...
  /**
   * Lists actions taken if ball hits the bottom of the map.
   */
